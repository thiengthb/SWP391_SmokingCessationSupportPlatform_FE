...
export default function PresetPlans({ applyPresetPlan }: PresetPlansProps) {
  ...
  const gradualReductionPlan = createPresetPlan("Giảm Dần (30 ngày)", 30, [
    {
      name: "Chuẩn bị",
      durationDays: 7,
      cigarettes: 15,
  ...
  const coldTurkeyPlan = createPresetPlan("Bỏ Thuốc Ngay (14 ngày)", 14, [
    {
  ...
  const extendedPlan = createPresetPlan("Kế Hoạch Dài Hạn (90 ngày)", 90, [
    {
      name: "Chuẩn bị",
      durationDays: 14,
      cigarettes: 15,
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card>
          <CardHeader className="pb-3">
            ...
            <CardDescription>
              Kế hoạch 30 ngày, giảm dần số lượng thuốc lá trước khi bỏ hoàn
              toàn
            </CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader className="pb-3">
            ...
            <CardDescription>
              Kế hoạch cai thuốc nhanh, ngừng hoàn toàn sau thời gian chuẩn bị
              ngắn
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-3">
        ...
        <Card>
          <CardHeader className="pb-3">
            ...
            <CardDescription>
              Kế hoạch toàn diện 90 ngày với các giai đoạn chuyển tiếp từ từ và
              duy trì
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-3">
      ...
      <div className="bg-muted/30 p-4 rounded-lg border mt-6">
        ...
        <ul className="space-y-2 text-sm">
          <li className="flex gap-2">
            ...
            <span>
              <strong>Giảm Dần:</strong> Thích hợp cho những người hút thuốc lâu
              năm, giúp giảm triệu chứng cai thuốc.
            </span>
          </li>
          <li className="flex gap-2">
            <CheckCheck className="h-4 w-4 text-primary mt-0.5 flex-shrink-0" />
            <span>
              <strong>Bỏ Thuốc Ngay:</strong> Phương pháp hiệu quả cho người đã
              sẵn sàng và có quyết tâm cao.
            </span>
          </li>
          <li className="flex gap-2">
            <CheckCheck className="h-4 w-4 text-primary mt-0.5 flex-shrink-0" />
            <span>
              <strong>Kế Hoạch Dài Hạn:</strong> Toàn diện nhất, giúp xây dựng
              thói quen mới và phòng ngừa tái nghiện.
            </span>
          </li>
        </ul>
      </div>
